          ...
          <div className="auth-card">
            {success === "account_deleted" && (
              <div className="auth-success" role="status">
                Your Convertix account and history have been deleted. You can
                still{" "}
            ...
            {error === "confirmation_failed" && (
              <div className="auth-alert" role="alert">
                This confirmation link has expired or could not be used. Open
                the latest email in the browser where you signed up, or{" "}
                <Link className="auth-back" href="/signup">
                  sign up again to request a fresh link
                </Link>
                .
              </div>
            )}
