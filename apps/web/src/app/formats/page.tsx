...
export const metadata: Metadata = {
  ...
  description:
    "Learn what common file formats are used for and find the Convertix converters that support them.",
  ...
  openGraph: {
    ...
    title: "File Formats and Conversion Guides",
    description:
      "Learn about common file formats and find converters for documents, images, audio and video.",
    siteName: "Convertix",
  },
  twitter: {
    ...
    description:
      "Learn about common file formats and find the Convertix converters that support them.",
  },
};
    ...
    <>
      <main id="main-content">
        ...
        <section
          ...
          aria-labelledby="live-formats-title"
        >
