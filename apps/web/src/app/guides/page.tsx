...
export const metadata: Metadata = {
  ...
  description:
    "Practical guides to PDF, DOCX, PNG, JPG, WebP, SVG, MP3, WAV, MP4 and WebM. Compare formats and choose the right converter.",
  ...
  openGraph: {
    ...
    description:
      "Practical file format comparisons and conversion guidance from Convertix.",
    siteName: "Convertix",
  },
  twitter: {
    ...
    <>
      <main id="main-content" className="guides-page">
        <header className="guides-hero">
          ...
          <p>
            Compare common formats, check compatibility, and see what may change
        ...
        <section className="guides-promo" aria-labelledby="guide-tools-title">
          <div>
            <h2 id="guide-tools-title">Already know what you need?</h2>
            <p>Open the full list of available converters.</p>
          </div>
          <FlowButton
            href="/conversions"
            variant="dark"
