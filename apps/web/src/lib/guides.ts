...
export const GUIDES: Guide[] = [
  ...
  },
  {
    ...
    eyebrow: "Images",
    intro: "PNG, JPG and WebP make different trade-offs between image quality, transparency, compatibility and file size. The best choice depends on where the image will be used.",
    updated: "2026-08-20",
    sections: [
      ...
      { heading: "A practical rule of thumb", paragraphs: ["Use PNG for lossless detail or transparency, JPG for photographs that need broad compatibility, and WebP for web images. Check the output because changing formats does not guarantee a smaller file." ] },
    ],
  ...
  },
  {
    ...
    sections: [
      ...
      { heading: "Some conversions are lossy", paragraphs: ["A destination format may discard information to reduce size or because it cannot store a feature from the source. That can affect image detail, audio information, transparency, document structure or metadata." ] },
